...
# Tambahkan gambar ke aplikasi
st.image('download.png', caption='DATA MINNING',  width=600)
...
def hitung_statistik(audio_file):
    zcr_data = pd.DataFrame(columns=['mean', 'std_dev', 'max_value', 'min_value', 'median', 'skewness', 'kurt', 'q1', 'q3', 'mode_value', 'iqr', 'ZCR Median', 'ZCR Std Deviasi', 'ZCR Skewness', 'ZCR Kurtosis'])
...
if uploaded_file is not None:
    ...
    if st.button("Deteksi Audio"):
        ...
        kolom = [ 'ZCR Median', 'ZCR Std Deviasi', 'ZCR Kurtosis', 'ZCR Skewness', 'RMS Mean', 'RMS Median', 'RMS Std Deviasi', 'RMS Kurtosis', 'RMS Skewness']

...
# Menyimpan DataFrame ke dalam file CSV
    ...
    with open('model_random_forest.pkl', 'rb') as model_file:
        classifier_rf = pickle.load(model_file)


# Pastikan bahwa Anda sudah memiliki variabel 'data_ternormalisasi' dan 'sklearn_pca' terdefinisi sebelumnya
    y_prediksi = classifier_rf.predict(data_ternormalisasi)
